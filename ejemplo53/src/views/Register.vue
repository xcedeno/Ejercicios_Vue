              ...
              <div class="card-body">
                ...
                <div class="form-row">
                  ...
                  <section class="col-sm-12 form-group">
                    ...
                    <input class="form-control" type="text" id="displayName" placeholder="Display Name" name="displayName" required v-model="displayName" />
                  </section>
                </div>
...
export default {
  ...
  methods: {
    register() {
      ...
      if (!this.error) {
        firebase.auth().createUserWithEmailAndPassword(informacion.email, informacion.password).then(response => {
          console.log(response)
          return response.user.updateProfile({
            displayName: informacion.displayName
          }).then(() => {
        ...
        this.error += "Debe solucionar los errores indicados"
      }
    }
  },
}
